...
`toc`<br/> ![Generic badge](https://img.shields.io/badge/Added_1.2.4-gray.svg)  | Array&nbsp;of&nbsp;Object | All instances of entities that have their `exportToToc` flag enabled are listed in this array.<br/> This array contains objects with the following fields:<br/> <ul class='subFields'><li>**`identifier`** **(String**)</li><li>**`instancesData`** **(Array of Object**)  ![Generic badge](https://img.shields.io/badge/Added_1.5.0-green.svg)  <ul class='subFields'><li>**`fields`** **(Array of Object**) : *An object containing the values of all entity fields with the `exportToToc` option enabled. This object typing depends on actual field value types.* <ul class='subFields'><li>**`__identifier`** **(String**)</li><li>**`__type`** **(String**)</li><li>**`__value`** **(Untyped**)</li></ul></li><li>**`heiPx`** **(Int**)</li><li>**`iids`** **([Reference to an Entity instance](#ldtk-EntityReferenceInfos)**) : *IID information of this instance*</li><li>**`widPx`** **(Int**)</li><li>**`worldX`** **(Int**)</li><li>**`worldY`** **(Int**)</li></ul></li><li>**`instances`** **(Array of [Reference to an Entity instance](#ldtk-EntityReferenceInfos)**)    : ***WARNING**: this deprecated value will be *removed* completely on version 1.7.0+* ** *Replaced by: `instancesData`*</li></ul>
...
Value | Type | Description
-- | -- | --
`compositeBackgrounds` | Array&nbsp;of&nbsp;[Composite&nbsp;Background&nbsp;definition](#ldtk-CompositeBackgroundDefJson) | All composite backgrounds
...
<a id="ldtk-CompositeBackgroundDefJson" name="ldtk-CompositeBackgroundDefJson"></a>
## 3.5. Composite Background definition   
Value | Type | Description
-- | -- | --
`backgrounds` | Array&nbsp;of&nbsp;[Background&nbsp;definition](#ldtk-BackgroundDefJson) | 
`identifier` | String | User defined unique identifier
`tags` | Array&nbsp;of&nbsp;String | An array of user-defined tags to organize the Composite Backgrounds
`uid` | Int | Unique Int identifier

<a id="ldtk-BackgroundDefJson" name="ldtk-BackgroundDefJson"></a>
## 3.5.1. Background definition   
Value | Type | Description
-- | -- | --
`identifier` | String | User defined unique identifier
`parallaxX` | Float | 
...
`pivotX` | Float | 
`pivotY` | Float | 
`pos` | Enum | Possible values: `Unscaled`, `Contain`, `Cover`, `CoverDirty`, `Repeat`, `Parallax`
`relPath` | String&nbsp;*(can&nbsp;be&nbsp;`null`)* | 
`repeatX` | Bool | 
`repeatY` | Bool | 
`uid` | Int | Unique Int identifier